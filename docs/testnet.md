...
4. Decrease/collect, Aave supply and manual principal restoration to the same NFT are complete. Implement the automatic in-range RETURN path with ratio swapping and fresh policy guards. Do not present manually staged testnet conditions as a profitable live strategy decision.
